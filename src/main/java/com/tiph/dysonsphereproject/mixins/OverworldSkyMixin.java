...
public abstract class OverworldSkyMixin extends DimensionSpecialEffects {
  ...
  public OverworldSkyMixin(
      float p_108866_, boolean p_108867_, SkyType p_108868_, boolean p_108869_, boolean p_108870_) {
  ...
  public void adjustLightmapColors(
    ...
    //        super.adjustLightmapColors(level, partialTicks, skyDarken, blockLightRedFlicker,
    // skyLight, pixelX, pixelY, colors);
  }
}
