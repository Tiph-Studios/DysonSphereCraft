...
public class WarpDislocatorMenu extends AbstractContainerMenu {
    public final WarpDislocatorBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;
    public WarpDislocatorMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public WarpDislocatorMenu(int containerId, Inventory inv, BlockEntity entity, ContainerData data) {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, DysonBlocks.WARP_DISLOCATOR.get());
    }
